...
export const tags = [
  ...
  { name: '早慶', category: '大学区分'},
  { name: '医学部', category: '大学区分'},
  { name: '名古屋大学', category: '大学区分'},
  { name: '立教大学', category: '大学区分'},
  { name: '音大', category: '大学区分'},
  { name: '現役', category: '受験区分'},
  { name: '浪人', category: '受験区分' },
  { name: '自己推薦', category: '受験区分' },
  { name: '指定校', category: '受験区分' },
  { name: '現役合格', category: '受験区分'},
  { name: '総合型選抜', category: '受験区分'},
  { name: '理系', category: '受験区分'},
  { name: '文系', category: '受験区分'},
  { name: '指定校推薦', category: '受験区分'},
  { name: '英語', category: '科目' },
  { name: '数学', category: '科目' },
  { name: '国語', category: '科目' },
  { name: '物理', category: '科目' },
  ...
  { name: '塾', category: 'その他'},
  { name: '予備校', category: 'その他'},
  { name: '勉強法', category: 'その他'},
  { name: 'メンタル', category: 'その他'},
  { name: '挫折', category: 'その他'},
  { name: 'ポモドーロ法', category: 'その他'},
  { name: '失敗談', category: 'その他'},
  { name: '部活', category: 'その他'},
  { name: '映像授業', category: 'その他'},
];
